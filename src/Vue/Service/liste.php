                       ...
                       href="/fileAttente/web/controleurFrontal.php?action=afficherDetail&controleur=service&idService=<?php echo $s->getIdService(); ?>">
                        ...
                        <div class="divNbPersonneStatut">
                            <div class="service-info">
                                ...
                                <?php echo "<p>$nbPersonneAttente personnes en attente</p>"; ?>
                            </div>
                            <?php echo "<div class='statutActifPub'>Service actif</div>"; ?>
                        </div>
                    </a>
